...
FUSION_VERSION_COMPATIBILITY_OUTPUT: dict[str, dict[str, Any]] = {
    ...
    "LewisDavies/upstream_prod": {
        ...
        "latest_fusion_compatible_version": "=0.9.9",
        "fusion_compatible_versions": ["=0.9.6", "=0.9.7", "=0.9.8", "=0.9.9"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.2.0",
        ...
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=0.9.9",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=0.9.9",
    },
    ...
    "ScalefreeCOM/datavault4dbt": {
        ...
        "latest_fusion_compatible_version": "=1.15.1",
        "fusion_compatible_versions": ["=1.14.0", "=1.15.0", "=1.15.1"],
        "fusion_incompatible_versions": [
            "=1.0.0",
            "=1.0.1",
            "=1.0.10",
        ...
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=1.15.1",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=1.15.1",
    },
    ...
    "dbt-labs/dbt_project_evaluator": {
        ...
        "fusion_compatible_versions": ["=1.1.2", "=1.2.0", "=1.2.1", "=1.2.2"],
        "fusion_incompatible_versions": [
            "=0.2.1",
            "=0.5.0",
            "=0.1.1",
    ...
    "elementary-data/elementary": {
        ...
        "latest_fusion_compatible_version": "=0.22.1",
        "fusion_compatible_versions": ["=0.21.0", "=0.22.0", "=0.22.1"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.10.0",
        ...
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=0.22.1",
        "package_redirect_name": "elementary",
        "package_redirect_namespace": "elementary-data",
        "latest_version_incl_prerelease": "=0.22.1",
    ...
    "fivetran/ad_reporting": {
        ...
        "oldest_fusion_compatible_version": "=0.1.0",
        "latest_fusion_compatible_version": "=2.4.0",
        "fusion_compatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.2.0",
        ...
        "fusion_incompatible_versions": [],
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=2.4.0",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=2.4.0",
    },
    "fivetran/amazon_ads": {
        "latest_version": "=1.2.0",
    ...
    "fivetran/amplitude": {
        ...
        "latest_fusion_compatible_version": "=1.3.1",
        "fusion_compatible_versions": ["=1.2.0", "=1.3.0", "=1.3.1-a1", "=1.3.1"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.2.0",
            "=0.3.0",
    ...
    "fivetran/aws_cloud_cost": {
        ...
        "fusion_compatible_versions": ["=0.2.0", "=0.3.0", "=0.3.1"],
        "fusion_incompatible_versions": ["=0.1.0"],
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=0.3.1",
        "package_redirect_name": None,
    ...
    "fivetran/intercom": {
        ...
        "fusion_compatible_versions": ["=0.3.0", "=0.3.1", "=1.3.0", "=1.4.0", "=1.5.0-a1", "=1.5.0", "=1.6.0"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.1.2",
    ...
    "fivetran/iterable": {
        ...
        "oldest_fusion_compatible_version": "=0.2.0",
        "latest_fusion_compatible_version": "=1.4.0",
        "fusion_compatible_versions": ["=0.2.0", "=0.3.0", "=0.3.1", "=1.2.0", "=1.3.0", "=1.3.1", "=1.4.0"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.10.0",
            "=0.11.0",
    ...
    "fivetran/klaviyo": {
        ...
        "oldest_fusion_compatible_version": "=0.2.0",
        "latest_fusion_compatible_version": "=1.3.0",
        "fusion_compatible_versions": ["=0.2.0", "=0.2.1", "=0.3.0", "=1.2.0", "=1.2.1", "=1.3.0"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.1.2",
    ...
    "fivetran/netsuite": {
        ...
        "oldest_fusion_compatible_version": "=0.1.1",
        "latest_fusion_compatible_version": "=1.4.0",
        "fusion_compatible_versions": ["=0.1.1", "=0.4.0", "=0.4.1", "=1.3.0", "=1.4.0-a1", "=1.4.0-a2", "=1.4.0"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.10.0",
            "=0.11.0",
    ...
    "fivetran/pinterest": {
        ...
        "latest_fusion_compatible_version": "=1.2.0",
        "fusion_compatible_versions": ["=0.4.0", "=1.1.0", "=1.2.0"],
        "fusion_incompatible_versions": [
            "=0.10.0",
            "=0.11.0",
            "=0.12.0",
    ...
    "fivetran/quickbooks": {
        "latest_version": "=1.4.0",
        "oldest_fusion_compatible_version": "=0.3.0",
        "latest_fusion_compatible_version": "=1.4.1-a1",
        "fusion_compatible_versions": ["=0.3.0", "=1.2.0", "=1.2.1", "=1.3.0", "=1.3.1", "=1.4.0", "=1.4.1-a1"],
        "fusion_incompatible_versions": [
            "=0.1.0",
            "=0.1.1",
            "=0.1.2",
        ...
        "package_redirect_namespace": "fivetran",
        "latest_version_incl_prerelease": "=1.4.1-a1",
    ...
    "fivetran/salesforce_marketing_cloud": {
        ...
        "oldest_fusion_compatible_version": "=0.4.0",
        "latest_fusion_compatible_version": "=0.5.0",
        "fusion_compatible_versions": ["=0.4.0", "=0.5.0"],
    ...
    "fivetran/sap": {
        ...
        "fusion_compatible_versions": ["=0.5.0", "=0.5.1", "=0.6.0"],
    ...
    "fivetran/workday": {
        ...
        "oldest_fusion_compatible_version": "=0.6.0",
        "latest_fusion_compatible_version": "=0.8.1",
        "fusion_compatible_versions": ["=0.6.0", "=0.7.0", "=0.8.0", "=0.8.1"],
        "fusion_incompatible_versions": ["=0.1.0", "=0.1.1", "=0.2.0", "=0.3.0", "=0.4.0", "=0.5.0"],
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=0.8.1",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=0.8.1",
    },
    "fivetran/xero": {
        "latest_version": "=1.3.0",
        "oldest_fusion_compatible_version": "=0.2.0",
    ...
    "get-select/dbt_snowflake_monitoring": {
        ...
        "oldest_fusion_compatible_version": "=5.5.1",
        "latest_fusion_compatible_version": "=5.5.1",
        "fusion_compatible_versions": ["=5.5.1"],
        "fusion_incompatible_versions": [
            "=1.0.0",
            "=1.1.0",
            "=1.2.0",
        ...
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=5.5.1",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=5.5.1",
    },
    "get-select/dbt_snowflake_query_tags": {
        "latest_version": "=2.6.0",
        "oldest_fusion_compatible_version": "=2.6.0",
        "latest_fusion_compatible_version": "=2.6.0",
        "fusion_compatible_versions": ["=2.6.0"],
        "fusion_incompatible_versions": [
            "=1.0.0",
            "=1.1.0",
            "=1.1.1",
    ...
    "godatadriven/dbt_date": {
        ...
        "oldest_fusion_compatible_version": "=0.1.1",
        "latest_fusion_compatible_version": "=0.17.1",
        "fusion_compatible_versions": [
            "=0.1.1",
            "=0.1.2",
            "=0.1.3",
        ...
        "fusion_incompatible_versions": [],
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=0.17.1",
        "package_redirect_name": "dbt_date",
        "package_redirect_namespace": "godatadriven",
        "latest_version_incl_prerelease": "=0.17.1",
    ...
    "henryupton/dbt_scd2_utils": {
        ...
        "oldest_fusion_compatible_version": "=0.0.1",
        "latest_fusion_compatible_version": "=1.0.29",
        "fusion_compatible_versions": [
            "=0.0.1",
            "=0.0.2",
            "=1.0.0",
        ...
        "fusion_incompatible_versions": [],
        "unknown_compatibility_versions": [],
        "package_latest_version_index_json": "=1.0.29",
        "package_redirect_name": None,
        "package_redirect_namespace": None,
        "latest_version_incl_prerelease": "=1.0.29",
    },
    ...
    "tuva-health/the_tuva_project": {
        ...
        "latest_fusion_compatible_version": "=0.16.2",
        "fusion_compatible_versions": [
            "=0.3.1",
            "=0.3.10",
            "=0.3.11",
        ...
        "package_latest_version_index_json": "=0.16.2",
        "package_redirect_name": "the_tuva_project",
        "package_redirect_namespace": "tuva-health",
        "latest_version_incl_prerelease": "=0.16.2",
