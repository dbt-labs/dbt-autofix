...
def main(
    ...
    conformance_output: dict[str, dict[str, dict[str, Any]]] = merge_autofix_output(
        [
            "conformance_autofix_output_fivetran_fishtown.json",
            "conformance_autofix_output_no_fivetran_fishtown_20260623.json",
        ],
        DEFAULT_OUTPUT_PATH,
    )
    ...
    # only upload subset
    orgs = set(
        ["brooklyn-data", "calogica", "dbt-labs", "elementary-data", "fishtown-analytics", "fivetran", "godatadriven"]
    )
