...
from dbt_package_tools.compatibility import (
    FusionConformanceResult,
    FusionLogMessage,
    ParseConformanceLogOutput,
)
from dbt_package_tools.dbt_package_version import DbtPackageVersion
from dbt_package_tools.exceptions import FusionBinaryNotAvailable
from dbt_package_tools.yaml.loader import safe_load
...
def run_conformance_for_version(
    ...
    parse_conformance = check_fusion_schema_compatibility(
