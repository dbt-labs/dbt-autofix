...
from dbt_package_tools.compatibility import FusionConformanceResult
from dbt_package_tools.exceptions import SemverError
...
DEFAULT_OUTPUT_PATH = current_dir / "src" / "dbt_package_tools" / "scripts" / "output"
...
DEFAULT_CONFORMANCE_OUTPUT_FILE = (
    current_dir / "src" / "dbt_package_tools" / "scripts" / "output" / "conformance_output.json"
)
